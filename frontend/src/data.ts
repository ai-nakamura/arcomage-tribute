...
export var sounds = {
  arcomage: {
    damage: new Audio("Sounds/Arcomage/damage.wav"),
    deal: new Audio("Sounds/Arcomage/deal.wav"),
    defeat: new Audio("Sounds/Arcomage/defeat.wav"),
    quarryDown: new Audio("Sounds/Arcomage/quarry_down.wav"),
    shuffle: new Audio("Sounds/Arcomage/shuffle.wav"),
    start: new Audio("Sounds/Arcomage/start.wav"),
    towerUp: new Audio("Sounds/Arcomage/tower_up.wav"),
    typing: new Audio("Sounds/Arcomage/typing.wav"),
    victory: new Audio("Sounds/Arcomage/victory.wav"),
  },
...
export var cards: Record<number, Card> = {
  ...
  4: {
    ...
    effect: (active, enemy) => ({
      active: {
        quarry: active.resources.quarry < enemy.resources.quarry ? +2 : +1,
      },
    }),
  },
